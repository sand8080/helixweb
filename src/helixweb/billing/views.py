...
from helixweb.billing.forms import (ModifyUsedCurrenciesForm,
    ...
    AddBonusForm, LockForm, UnlockForm, ChargeOffForm, BillingForm)
from helixweb.billing.forms_filters import (FilterAllActionLogsForm,
    ...
    FilterSelfTransactionsForm, FilterUsedCurrenciesForm, FilterCurrenciesForm)
...
def currencies(request):
    c = {}
    form = FilterCurrenciesForm(request=request)
    if form.is_valid():
...
def transactions(request):
    return _transactions(request, FilterTransactionsForm, 'balance/transactions.html',
        None, None)


@login_redirector
def user_transactions(request, user_id, balance_id):
    return _transactions(request, FilterUserTransactionsForm, 'user/transactions.html',
        user_id, balance_id)
